...
require 'kickstart.config.splits'
require 'kickstart.config.tabs'
...
-- Sets the level of text concealment in the editor (e.g., hiding certain syntax elements, useful for markdown)
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Setup for highlighting word under cursor
  ...
  -- Themes
  require 'kickstart.themes.pop-punk',
  require 'kickstart.themes.decay',
  require 'kickstart.themes.adwaita',
